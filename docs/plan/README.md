...
| 002 | [Electron 透過オーバーレイが画面共有に映るか](./002-electron-overlay-on-screen-share.md) | 検証 | **完了** | T-004 |
| 003 | [Zoom 抜きでコメントが流れる状態を作る](./003-overlay-with-debug-source.md) | 実装 | 進行中 | T-005〜T-009 |
...
002 の結果、**表示方式は Electron 単体に確定**した(OBS は使わない)。
